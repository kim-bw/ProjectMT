...
<table width = "800" border = "-1">
	<tr>
		...
		<td>f_select</td>
		<td><input type = "title" name = "f_select" value = "${Rvo.f_select}"></td>
		<td>f_name</td>
		<td><input type = "content" name = "f_name" value = "${Rvo.f_name}"></td>
		<td>f_address</td>
		<td><input type = "content" name = "f_address" value = "${Rvo.f_address}"></td>
		<td>f_detailaddress</td>
		<td><input type = "text" name = "f_detailaddress" value = "${Rvo.f_detailaddress}"></td>
		<td>f_areacode</td>
		<td><input type = "text" name = "f_areacode" value = "${Rvo.f_areacode}"></td>
		<td>f_location</td>
		<td><input type = "text" name = "f_location" value = "${Rvo.f_location}"></td>
		<td>f_good</td>
		<td><input type = "text" name = "f_good" value = "${Rvo.f_good}"></td>
		<td>f_bad</td>
		<td><input type = "text" name = "f_bad" value = "${Rvo.f_bad}"></td>
		<td>f_point</td>
		<td><input type = "text" name = "f_point" value = "${Rvo.f_point}"></td>
		<td>f_rank</td>
		<td><input type = "text" name = "f_rank" value = "${Rvo.f_rank}"></td>
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                   정보 : <input type="text" value="${Rvo.f_address} ${Rvo.f_detailaddress}" id="keyword" size="15"> 
